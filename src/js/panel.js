...
import { S, TYPE_META, typeOf, getEnt, esc, attackUrl, profileHas, profileToggle, switchView } from './app.js'
...
export const Panel = (() => {
  ...
  function show(id) {
    ...
    if (gBtn) gBtn.addEventListener("click", () => {
      window.Graph.addEntity(id, { focus: S.view === "explore" });
    ...
    if (dBtn) dBtn.addEventListener("click", () => window.Detect.focus(id));
  }
